...
export default function Spiders() {
  const spiderwebs = [
    { id: 1, src: "/assets/images/web1.png", className: "top-0 left-0 h-[55vh] w-auto opacity-70" },
    { id: 2, src: "/assets/images/web2.png", className: "top-0 right-0 h-[55vh] w-auto opacity-70" },
    { id: 3, src: "/assets/images/web3.png", className: "top-0 left-0 h-[55vh] w-auto opacity-70 rotate-[345deg]" },
  ];
    ...
    <div className="absolute inset-0 bg-[url('/assets/images/eerie-hospital.png')] bg-cover bg-bottom">
      ...
      {spiderwebs.map((web) =>
        visibleWebs.includes(web.id) ? (
          <div
            key={web.id}
            className={`absolute ${web.className}`}
          >
            <Image
              src={web.src}
              alt="web"
